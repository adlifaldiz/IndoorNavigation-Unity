    ...
    public class IndoorNavController : MonoBehaviour
    {
        ...
        private void UpdateApplicationLifecycle()
        {
            ...
            {
                Tracking = false;
                ErrorText.text = "Kehilangan arah, mohon tunggu ...";
            ...
            {
                if(ErrorText.text.Equals("Kehilangan arah, mohon tunggu ..."))
                {
                    ErrorText.text = "";
                }
            ...
            {
                ShowAndroidToastMessage("Perizinan Kamera dibutuhkan untuk menggunakan aplikasi ini.");
                IsQuitting = true;
                Invoke("DoQuit", 0.5f);
            }
            else if (Session.Status.IsError())
            {
                ShowAndroidToastMessage(
                    "ARCore mengalami kendala dalam koneksi.  Mohon restart aplikasi.");
                IsQuitting = true;
                Invoke("DoQuit", 0.5f);
            }
        }
